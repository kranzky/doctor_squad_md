...
class Context3D_obj : public hx::Object{
	...
	public:
		...
		virtual Void setGLSLVertexBufferAt( ::String locationName,::native::display3D::VertexBuffer3D buffer,hx::Null< int >  bufferOffset,::native::display3D::Context3DVertexBufferFormat format);
		...
		virtual Void setGLSLTextureAt( ::String locationName,::native::display3D::textures::TextureBase texture);
		...
		virtual Void setGLSLProgramConstantsFromMatrix( ::String locationName,::native::geom::Matrix3D matrix,hx::Null< bool >  transposedMatrix);
		Dynamic setGLSLProgramConstantsFromMatrix_dyn();

		virtual Void setGLSLProgramConstantsFromByteArray( ::String locationName,::native::utils::ByteArray data,hx::Null< int >  byteArrayOffset);
		...
		virtual Void setProgramConstantsFromMatrix( ::native::display3D::Context3DProgramType programType,int firstRegister,::native::geom::Matrix3D matrix,hx::Null< bool >  transposedMatrix);
		...
		virtual ::String getUniformLocationNameFromAgalRegisterIndex( ::native::display3D::Context3DProgramType programType,int firstRegister);
		...
		Array< ::native::display3D::textures::TextureBase > texturesCreated; /* REM */ 
		Array< ::native::display3D::Program3D > programsCreated; /* REM */ 
		Array< ::native::display3D::IndexBuffer3D > indexBuffersCreated; /* REM */ 
		Array< ::native::display3D::VertexBuffer3D > vertexBuffersCreated; /* REM */ 
		bool disposed; /* REM */ 
		bool drawing; /* REM */ 
