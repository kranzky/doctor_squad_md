...
{
HX_STACK_PUSH("Socket::new","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",132);
{
	HX_STACK_LINE(133)
...
{
		HX_STACK_PUSH("Socket::setFastSend","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",218);
		HX_STACK_THIS(this);
		HX_STACK_ARG(b,"b");
		HX_STACK_LINE(218)
...
{
		HX_STACK_PUSH("Socket::setBlocking","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",214);
		HX_STACK_THIS(this);
		HX_STACK_ARG(b,"b");
		HX_STACK_LINE(214)
...
{
		HX_STACK_PUSH("Socket::waitForRead","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",210);
		HX_STACK_THIS(this);
		HX_STACK_LINE(210)
...
{
		HX_STACK_PUSH("Socket::setTimeout","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",206);
		HX_STACK_THIS(this);
...
Dynamic Socket_obj::host( ){
	HX_STACK_PUSH("Socket::host","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",199);
	HX_STACK_THIS(this);
	HX_STACK_LINE(200)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::sys::net::Host &h,Dynamic &a){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",203);
			{
...
Dynamic Socket_obj::peer( ){
	HX_STACK_PUSH("Socket::peer","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",192);
	HX_STACK_THIS(this);
	HX_STACK_LINE(193)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::sys::net::Host &h,Dynamic &a){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",196);
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("host") , h,false);
				__result->Add(HX_CSTRING("port") , a->__GetItem((int)1),false);
...
::sys::net::Socket Socket_obj::accept( ){
	HX_STACK_PUSH("Socket::accept","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",183);
	HX_STACK_THIS(this);
	HX_STACK_LINE(184)
...
{
		HX_STACK_PUSH("Socket::bind","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",179);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Socket::shutdown","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",175);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Socket::listen","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",171);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Socket::connect","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",160);
		HX_STACK_THIS(this);
		HX_STACK_ARG(host,"host");
		HX_STACK_ARG(port,"port");
		HX_STACK_LINE(160)
					...
					if (((s == HX_CSTRING("std@socket_connect")))){
						struct _Function_3_1{
							inline static ::String Block( ::sys::net::Host &host){
								HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",165);
								{
									HX_STACK_LINE(165)
									try{
										HX_STACK_LINE(165)
...
{
		HX_STACK_PUSH("Socket::write","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",156);
		HX_STACK_THIS(this);
...
::String Socket_obj::read( ){
	HX_STACK_PUSH("Socket::read","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",150);
	HX_STACK_THIS(this);
	HX_STACK_LINE(151)
...
{
		HX_STACK_PUSH("Socket::close","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",138);
		HX_STACK_THIS(this);
		HX_STACK_LINE(139)
...
Dynamic Socket_obj::select( Array< ::sys::net::Socket > read,Array< ::sys::net::Socket > write,Array< ::sys::net::Socket > others,Dynamic timeout){
	HX_STACK_PUSH("Socket::select","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",222);
	HX_STACK_ARG(read,"read");
	HX_STACK_ARG(write,"write");
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< Array< ::sys::net::Socket > > &neko_array){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",226);
			{
				hx::Anon __result = hx::Anon_obj::Create();
