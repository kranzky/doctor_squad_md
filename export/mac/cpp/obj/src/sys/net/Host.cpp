...
{
HX_STACK_PUSH("Host::new","/usr/lib/haxe/std/cpp/_std/sys/net/Host.hx",33);
{
	HX_STACK_LINE(33)
...
HX_STACK_PUSH("Host::__init__","/usr/lib/haxe/std/cpp/_std/sys/net/Host.hx",49);
{
	HX_STACK_LINE(49)
...
::String Host_obj::reverse( ){
	HX_STACK_PUSH("Host::reverse","/usr/lib/haxe/std/cpp/_std/sys/net/Host.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_LINE(41)
...
::String Host_obj::toString( ){
	HX_STACK_PUSH("Host::toString","/usr/lib/haxe/std/cpp/_std/sys/net/Host.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
...
::String Host_obj::localhost( ){
	HX_STACK_PUSH("Host::localhost","/usr/lib/haxe/std/cpp/_std/sys/net/Host.hx",45);
	HX_STACK_LINE(45)
