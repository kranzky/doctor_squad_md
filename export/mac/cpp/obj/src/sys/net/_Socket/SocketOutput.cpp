...
{
HX_STACK_PUSH("SocketOutput::new","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",84);
{
	HX_STACK_LINE(84)
	this->__s = s;
}
...
{
		HX_STACK_PUSH("SocketOutput::close","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",112);
		HX_STACK_THIS(this);
		HX_STACK_LINE(113)
		this->super::close();
		HX_STACK_LINE(114)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_PUSH("SocketOutput::writeBytes","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",101);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::sys::net::_Socket::SocketOutput_obj *__this,::haxe::io::Bytes &buf,int &pos,int &len){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",102);
			{
				HX_STACK_LINE(102)
				try{
					HX_STACK_LINE(102)
...
{
		HX_STACK_PUSH("SocketOutput::writeByte","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",88);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(89)
		if (((this->__s == null()))){
