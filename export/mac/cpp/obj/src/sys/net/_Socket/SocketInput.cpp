...
{
HX_STACK_PUSH("SocketInput::new","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",35);
{
	HX_STACK_LINE(35)
	this->__s = s;
}
...
{
		HX_STACK_PUSH("SocketInput::close","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",69);
		HX_STACK_THIS(this);
		HX_STACK_LINE(70)
		this->super::close();
		HX_STACK_LINE(71)
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_PUSH("SocketInput::readBytes","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",52);
	HX_STACK_THIS(this);
...
int SocketInput_obj::readByte( ){
	HX_STACK_PUSH("SocketInput::readByte","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",39);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static int Block( ::sys::net::_Socket::SocketInput_obj *__this){
			HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/cpp/_std/sys/net/Socket.hx",40);
			{
				HX_STACK_LINE(40)
				try{
					HX_STACK_LINE(40)
