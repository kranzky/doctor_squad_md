...
{
HX_STACK_PUSH("Object::new","native/gl/GL.hx",1593);
{
	HX_STACK_LINE(1593)
...
bool Object_obj::get_valid( ){
	HX_STACK_PUSH("Object::get_valid","native/gl/GL.hx",1602);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1602)
	return this->isValid();
}
...
bool Object_obj::get_invalidated( ){
	HX_STACK_PUSH("Object::get_invalidated","native/gl/GL.hx",1601);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1601)
...
bool Object_obj::isInvalid( ){
	HX_STACK_PUSH("Object::isInvalid","native/gl/GL.hx",1598);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1598)
	return !(this->isValid());
}
...
bool Object_obj::isValid( ){
	HX_STACK_PUSH("Object::isValid","native/gl/GL.hx",1597);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1597)
...
::String Object_obj::toString( ){
	HX_STACK_PUSH("Object::toString","native/gl/GL.hx",1596);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1596)
...
{
		HX_STACK_PUSH("Object::invalidate","native/gl/GL.hx",1595);
		HX_STACK_THIS(this);
		HX_STACK_LINE(1595)
		this->id = null();
	}
...
::String Object_obj::getType( ){
	HX_STACK_PUSH("Object::getType","native/gl/GL.hx",1594);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1594)
