...
{
HX_STACK_PUSH("Program::new","native/gl/GL.hx",1630);
{
	HX_STACK_LINE(1632)
...
Array< ::native::gl::Shader > Program_obj::getShaders( ){
	HX_STACK_PUSH("Program::getShaders","native/gl/GL.hx",1640);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1640)
...
::String Program_obj::getType( ){
	HX_STACK_PUSH("Program::getType","native/gl/GL.hx",1639);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1639)
...
{
		HX_STACK_PUSH("Program::attach","native/gl/GL.hx",1638);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(1638)
		this->shaders->push(s);
