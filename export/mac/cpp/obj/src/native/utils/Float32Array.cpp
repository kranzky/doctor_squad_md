...
{
		HX_STACK_PUSH("Float32Array::__set","native/utils/Float32Array.hx",71);
		HX_STACK_THIS(this);
...
Float Float32Array_obj::__get( int index){
	HX_STACK_PUSH("Float32Array::__get","native/utils/Float32Array.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_ARG(index,"index");
	HX_STACK_LINE(70)
...
::native::utils::Float32Array Float32Array_obj::fromMatrix( ::native::geom::Matrix3D inMatrix){
	HX_STACK_PUSH("Float32Array::fromMatrix","native/utils/Float32Array.hx",63);
