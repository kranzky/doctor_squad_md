...
HX_STACK_PUSH("Multitouch::__init__","native/ui/Multitouch.hx",19);
{
	HX_STACK_LINE(21)
...
::native::ui::MultitouchInputMode Multitouch_obj::get_inputMode( ){
	HX_STACK_PUSH("Multitouch::get_inputMode","native/ui/Multitouch.hx",35);
	HX_STACK_LINE(35)
...
::native::ui::MultitouchInputMode Multitouch_obj::set_inputMode( ::native::ui::MultitouchInputMode inMode){
	HX_STACK_PUSH("Multitouch::set_inputMode","native/ui/Multitouch.hx",46);
...
bool Multitouch_obj::get_supportsTouchEvents( ){
	HX_STACK_PUSH("Multitouch::get_supportsTouchEvents","native/ui/Multitouch.hx",58);
	HX_STACK_LINE(58)
