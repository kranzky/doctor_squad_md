...
{
HX_STACK_PUSH("VertexBuffer3D::new","native/display3D/VertexBuffer3D.hx",19);
{
	HX_STACK_LINE(21)
...
{
		HX_STACK_PUSH("VertexBuffer3D::uploadFromVector","native/display3D/VertexBuffer3D.hx",39);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(41)
		::native::gl::GL_obj::bufferData((int)34962,::native::utils::Float32Array_obj::__new(data,startVertex,(numVertices * this->data32PerVertex)),(int)35044);
	}
return null();
}
...
{
		HX_STACK_PUSH("VertexBuffer3D::uploadFromByteArray","native/display3D/VertexBuffer3D.hx",32);
		HX_STACK_THIS(this);
		...
		::native::gl::GL_obj::bindBuffer((int)34962,this->glBuffer);
		HX_STACK_LINE(35)
		::native::gl::GL_obj::bufferData((int)34962,::native::utils::ArrayBufferView_obj::__new(byteArray,(byteArrayOffset + (startOffset * bytesPerVertex)),(count * bytesPerVertex)),(int)35044);
	}
return null();
}
...
{
		HX_STACK_PUSH("VertexBuffer3D::dispose","native/display3D/VertexBuffer3D.hx",27);
		HX_STACK_THIS(this);
		HX_STACK_LINE(27)
		::native::gl::GL_obj::deleteBuffer(this->glBuffer);
	}
return null();
}
