...
{
HX_STACK_PUSH("IndexBuffer3D::new","native/display3D/IndexBuffer3D.hx",19);
{
	HX_STACK_LINE(21)
...
{
		HX_STACK_PUSH("IndexBuffer3D::dispose","native/display3D/IndexBuffer3D.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_LINE(39)
...
Void IndexBuffer3D_obj::uploadFromVector( Array< int > data,int startOffset,int count){
{
		...
		HX_STACK_LINE(36)
		::native::gl::GL_obj::bufferData((int)34963,::native::utils::Float32Array_obj::__new(data,startOffset,count),(int)35044);
	}
return null();
}
...
{
		HX_STACK_PUSH("IndexBuffer3D::uploadFromByteArray","native/display3D/IndexBuffer3D.hx",27);
		HX_STACK_THIS(this);
		...
		::native::gl::GL_obj::bindBuffer((int)34963,this->glBuffer);
		HX_STACK_LINE(30)
		::native::gl::GL_obj::bufferData((int)34963,::native::utils::ArrayBufferView_obj::__new(byteArray,(byteArrayOffset + (startOffset * bytesPerIndex)),(count * bytesPerIndex)),(int)35044);
	}
return null();
}
