...
{
HX_STACK_PUSH("Texture::new","native/display3D/textures/Texture.hx",15);
{
	HX_STACK_LINE(15)
...
int miplevel = __o_miplevel.Default(0);
	HX_STACK_PUSH("Texture::uploadFromByteArray","native/display3D/textures/Texture.hx",40);
	HX_STACK_THIS(this);
...
int miplevel = __o_miplevel.Default(0);
	HX_STACK_PUSH("Texture::uploadFromBitmapData","native/display3D/textures/Texture.hx",29);
	HX_STACK_THIS(this);
	...
	HX_STACK_ARG(miplevel,"miplevel");
{
		...
		struct _Function_1_1{
			inline static ::native::utils::ByteArray Block( ::native::display::BitmapData &bitmapData){
				HX_STACK_PUSH("*::closure","native/display3D/textures/Texture.hx",33);
				{
					HX_STACK_LINE(33)
		...
		HX_STACK_LINE(33)
		::native::utils::ByteArray p = _Function_1_1::Block(bitmapData);		HX_STACK_VAR(p,"p");
		HX_STACK_LINE(35)
...
bool async = __o_async.Default(false);
	HX_STACK_PUSH("Texture::uploadCompressedTextureFromByteArray","native/display3D/textures/Texture.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_ARG(data,"data");
	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset");
