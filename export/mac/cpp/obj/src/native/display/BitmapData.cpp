...
{
HX_STACK_PUSH("BitmapData::new","native/display/BitmapData.hx",40);
	...
	if (((inFillRGBA == null()))){
		...
		struct _Function_2_1{
			inline static int Block( Dynamic &inFillRGBA){
				HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",52);
				{
					HX_STACK_LINE(52)
...
bool BitmapData_obj::get_transparent( ){
	HX_STACK_PUSH("BitmapData::get_transparent","native/display/BitmapData.hx",441);
	HX_STACK_THIS(this);
	HX_STACK_LINE(441)
...
int BitmapData_obj::get_height( ){
	HX_STACK_PUSH("BitmapData::get_height","native/display/BitmapData.hx",440);
	HX_STACK_THIS(this);
	HX_STACK_LINE(440)
...
int BitmapData_obj::get_width( ){
	HX_STACK_PUSH("BitmapData::get_width","native/display/BitmapData.hx",439);
	HX_STACK_THIS(this);
	HX_STACK_LINE(439)
...
::native::geom::Rectangle BitmapData_obj::get_rect( ){
	HX_STACK_PUSH("BitmapData::get_rect","native/display/BitmapData.hx",438);
	HX_STACK_THIS(this);
	HX_STACK_LINE(438)
...
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::noise","native/display/BitmapData.hx",424);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setFormat","native/display/BitmapData.hx",417);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::unlock","native/display/BitmapData.hx",410);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setVector","native/display/BitmapData.hx",392);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixels","native/display/BitmapData.hx",382);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
...
{
		HX_STACK_PUSH("BitmapData::setPixel32","native/display/BitmapData.hx",371);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::setPixel","native/display/BitmapData.hx",364);
		HX_STACK_THIS(this);
		HX_STACK_ARG(inX,"inX");
		HX_STACK_ARG(inY,"inY");
		HX_STACK_ARG(inColour,"inColour");
...
{
		HX_STACK_PUSH("BitmapData::setFlags","native/display/BitmapData.hx",356);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::scroll","native/display/BitmapData.hx",349);
		HX_STACK_THIS(this);
...
int channelOptions = __o_channelOptions.Default(7);
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_PUSH("BitmapData::perlinNoise","native/display/BitmapData.hx",341);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::nmeDrawToSurface","native/display/BitmapData.hx",333);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::lock","native/display/BitmapData.hx",326);
		HX_STACK_THIS(this);
	}
return null();
}
...
Array< int > BitmapData_obj::getVector( ::native::geom::Rectangle rect){
	HX_STACK_PUSH("BitmapData::getVector","native/display/BitmapData.hx",279);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_LINE(281)
...
::native::utils::ByteArray BitmapData_obj::getPixels( ::native::geom::Rectangle rect){
	HX_STACK_PUSH("BitmapData::getPixels","native/display/BitmapData.hx",247);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_LINE(249)
...
int BitmapData_obj::getPixel32( int x,int y){
	HX_STACK_PUSH("BitmapData::getPixel32","native/display/BitmapData.hx",236);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
	HX_STACK_LINE(236)
...
int BitmapData_obj::getPixel( int x,int y){
	HX_STACK_PUSH("BitmapData::getPixel","native/display/BitmapData.hx",229);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
	HX_STACK_LINE(229)
...
bool findColor = __o_findColor.Default(true);
	HX_STACK_PUSH("BitmapData::getColorBoundsRect","native/display/BitmapData.hx",220);
	HX_STACK_THIS(this);
...
::native::geom::Rectangle BitmapData_obj::generateFilterRect( ::native::geom::Rectangle sourceRect,::native::filters::BitmapFilter filter){
	HX_STACK_PUSH("BitmapData::generateFilterRect","native/display/BitmapData.hx",211);
	HX_STACK_THIS(this);
...
int inAlpha = __o_inAlpha.Default(255);
	HX_STACK_PUSH("BitmapData::fillRectEx","native/display/BitmapData.hx",204);
	HX_STACK_THIS(this);
	HX_STACK_ARG(rect,"rect");
	HX_STACK_ARG(inColour,"inColour");
...
{
		HX_STACK_PUSH("BitmapData::fillRect","native/display/BitmapData.hx",195);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
		HX_STACK_ARG(inColour,"inColour");
		HX_STACK_LINE(197)
...
Float inQuality = __o_inQuality.Default(0.9);
	HX_STACK_PUSH("BitmapData::encode","native/display/BitmapData.hx",166);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::dumpBits","native/display/BitmapData.hx",159);
		HX_STACK_THIS(this);
		HX_STACK_LINE(159)
...
bool smoothing = __o_smoothing.Default(false);
	HX_STACK_PUSH("BitmapData::draw","native/display/BitmapData.hx",152);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::dispose","native/display/BitmapData.hx",145);
		HX_STACK_THIS(this);
		HX_STACK_LINE(145)
		this->nmeHandle = null();
	}
...
{
		HX_STACK_PUSH("BitmapData::destroyHardwareSurface","native/display/BitmapData.hx",137);
		HX_STACK_THIS(this);
		HX_STACK_LINE(137)
...
{
		HX_STACK_PUSH("BitmapData::createHardwareSurface","native/display/BitmapData.hx",130);
		HX_STACK_THIS(this);
		HX_STACK_LINE(130)
...
bool mergeAlpha = __o_mergeAlpha.Default(false);
	HX_STACK_PUSH("BitmapData::copyPixels","native/display/BitmapData.hx",111);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BitmapData::copyChannel","native/display/BitmapData.hx",104);
		HX_STACK_THIS(this);
		HX_STACK_ARG(sourceBitmapData,"sourceBitmapData");
		HX_STACK_ARG(sourceRect,"sourceRect");
		HX_STACK_ARG(destPoint,"destPoint");
...
{
		HX_STACK_PUSH("BitmapData::colorTransform","native/display/BitmapData.hx",97);
		HX_STACK_THIS(this);
		HX_STACK_ARG(rect,"rect");
		HX_STACK_ARG(colorTransform,"colorTransform");
		HX_STACK_LINE(97)
...
::native::display::BitmapData BitmapData_obj::clone( ){
	HX_STACK_PUSH("BitmapData::clone","native/display/BitmapData.hx",88);
	HX_STACK_THIS(this);
	HX_STACK_LINE(90)
...
{
		HX_STACK_PUSH("BitmapData::applyFilter","native/display/BitmapData.hx",74);
		HX_STACK_THIS(this);
		HX_STACK_ARG(sourceBitmapData,"sourceBitmapData");
		HX_STACK_ARG(sourceRect,"sourceRect");
		HX_STACK_ARG(destPoint,"destPoint");
...
int inAlpha = __o_inAlpha.Default(255);
	HX_STACK_PUSH("BitmapData::createColor","native/display/BitmapData.hx",118);
...
int BitmapData_obj::extractAlpha( int v){
	HX_STACK_PUSH("BitmapData::extractAlpha","native/display/BitmapData.hx",173);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(173)
	return hx::UShr(v,(int)24);
}
...
int BitmapData_obj::extractColor( int v){
	HX_STACK_PUSH("BitmapData::extractColor","native/display/BitmapData.hx",184);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(184)
	return (int(v) & int((int)16777215));
}
...
::native::utils::ByteArray BitmapData_obj::getRGBAPixels( ::native::display::BitmapData bitmapData){
	HX_STACK_PUSH("BitmapData::getRGBAPixels","native/display/BitmapData.hx",256);
...
int format = __o_format.Default(0);
	HX_STACK_PUSH("BitmapData::load","native/display/BitmapData.hx",301);
...
::native::display::BitmapData BitmapData_obj::loadFromBytes( ::native::utils::ByteArray inBytes,::native::utils::ByteArray inRawAlpha){
	HX_STACK_PUSH("BitmapData::loadFromBytes","native/display/BitmapData.hx",310);
...
::native::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes inBytes,::haxe::io::Bytes inRawAlpha){
	HX_STACK_PUSH("BitmapData::loadFromHaxeBytes","native/display/BitmapData.hx",319);
	HX_STACK_ARG(inBytes,"inBytes");
	HX_STACK_ARG(inRawAlpha,"inRawAlpha");
	HX_STACK_LINE(319)
...
struct _Function_0_1{
	inline static int Block( ){
		HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",18);
		{
			HX_STACK_LINE(18)
