...
{
HX_STACK_PUSH("OptimizedPerlin::new","native/display/BitmapData.hx",566);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","native/display/BitmapData.hx",715);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","native/display/BitmapData.hx",692);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::fill","native/display/BitmapData.hx",575);
		HX_STACK_THIS(this);
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",636);
										{
											HX_STACK_LINE(636)
								...
								struct _Function_7_3{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",639);
										{
											HX_STACK_LINE(639)
								...
								struct _Function_7_5{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",642);
										{
											HX_STACK_LINE(642)
								...
								struct _Function_7_7{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",645);
										{
											HX_STACK_LINE(645)
								...
								struct _Function_7_9{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",648);
										{
											HX_STACK_LINE(648)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",651);
										{
											HX_STACK_LINE(651)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",654);
										{
											HX_STACK_LINE(654)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",657);
										{
											HX_STACK_LINE(657)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
