...
bool TextField_obj::set_wordWrap( bool inVal){
	HX_STACK_PUSH("TextField::set_wordWrap","native/text/TextField.hx",129);
	HX_STACK_THIS(this);
...
bool TextField_obj::get_wordWrap( ){
	HX_STACK_PUSH("TextField::get_wordWrap","native/text/TextField.hx",128);
	HX_STACK_THIS(this);
	HX_STACK_LINE(128)
...
::native::text::TextFieldType TextField_obj::set_type( ::native::text::TextFieldType inType){
	HX_STACK_PUSH("TextField::set_type","native/text/TextField.hx",127);
	HX_STACK_THIS(this);
...
::native::text::TextFieldType TextField_obj::get_type( ){
	HX_STACK_PUSH("TextField::get_type","native/text/TextField.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(126)
...
Float TextField_obj::get_textHeight( ){
	HX_STACK_PUSH("TextField::get_textHeight","native/text/TextField.hx",125);
	HX_STACK_THIS(this);
	HX_STACK_LINE(125)
...
Float TextField_obj::get_textWidth( ){
	HX_STACK_PUSH("TextField::get_textWidth","native/text/TextField.hx",124);
	HX_STACK_THIS(this);
	HX_STACK_LINE(124)
...
int TextField_obj::set_textColor( int inCol){
	HX_STACK_PUSH("TextField::set_textColor","native/text/TextField.hx",123);
	HX_STACK_THIS(this);
...
int TextField_obj::get_textColor( ){
	HX_STACK_PUSH("TextField::get_textColor","native/text/TextField.hx",122);
	HX_STACK_THIS(this);
	HX_STACK_LINE(122)
...
::String TextField_obj::set_text( ::String inText){
	HX_STACK_PUSH("TextField::set_text","native/text/TextField.hx",121);
	HX_STACK_THIS(this);
...
::String TextField_obj::get_text( ){
	HX_STACK_PUSH("TextField::get_text","native/text/TextField.hx",120);
	HX_STACK_THIS(this);
	HX_STACK_LINE(120)
...
bool TextField_obj::set_selectable( bool inSel){
	HX_STACK_PUSH("TextField::set_selectable","native/text/TextField.hx",119);
	HX_STACK_THIS(this);
...
bool TextField_obj::get_selectable( ){
	HX_STACK_PUSH("TextField::get_selectable","native/text/TextField.hx",118);
	HX_STACK_THIS(this);
	HX_STACK_LINE(118)
...
int TextField_obj::set_scrollV( int inVal){
	HX_STACK_PUSH("TextField::set_scrollV","native/text/TextField.hx",117);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(117)
...
int TextField_obj::get_scrollV( ){
	HX_STACK_PUSH("TextField::get_scrollV","native/text/TextField.hx",116);
	HX_STACK_THIS(this);
	HX_STACK_LINE(116)
...
int TextField_obj::set_scrollH( int inVal){
	HX_STACK_PUSH("TextField::set_scrollH","native/text/TextField.hx",115);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(115)
...
int TextField_obj::get_scrollH( ){
	HX_STACK_PUSH("TextField::get_scrollH","native/text/TextField.hx",114);
	HX_STACK_THIS(this);
	HX_STACK_LINE(114)
...
int TextField_obj::get_numLines( ){
	HX_STACK_PUSH("TextField::get_numLines","native/text/TextField.hx",113);
	HX_STACK_THIS(this);
	HX_STACK_LINE(113)
...
bool TextField_obj::set_multiline( bool inVal){
	HX_STACK_PUSH("TextField::set_multiline","native/text/TextField.hx",112);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(112)
...
bool TextField_obj::get_multiline( ){
	HX_STACK_PUSH("TextField::get_multiline","native/text/TextField.hx",111);
	HX_STACK_THIS(this);
	HX_STACK_LINE(111)
...
int TextField_obj::get_maxScrollV( ){
	HX_STACK_PUSH("TextField::get_maxScrollV","native/text/TextField.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
...
int TextField_obj::get_maxScrollH( ){
	HX_STACK_PUSH("TextField::get_maxScrollH","native/text/TextField.hx",109);
	HX_STACK_THIS(this);
	HX_STACK_LINE(109)
...
int TextField_obj::set_maxChars( int inVal){
	HX_STACK_PUSH("TextField::set_maxChars","native/text/TextField.hx",108);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(108)
...
int TextField_obj::get_maxChars( ){
	HX_STACK_PUSH("TextField::get_maxChars","native/text/TextField.hx",107);
	HX_STACK_THIS(this);
	HX_STACK_LINE(107)
...
::String TextField_obj::set_htmlText( ::String inText){
	HX_STACK_PUSH("TextField::set_htmlText","native/text/TextField.hx",106);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inText,"inText");
	HX_STACK_LINE(106)
...
::String TextField_obj::get_htmlText( ){
	HX_STACK_PUSH("TextField::get_htmlText","native/text/TextField.hx",105);
	HX_STACK_THIS(this);
	HX_STACK_LINE(105)
...
bool TextField_obj::set_embedFonts( bool value){
	HX_STACK_PUSH("TextField::set_embedFonts","native/text/TextField.hx",104);
	HX_STACK_THIS(this);
...
bool TextField_obj::get_embedFonts( ){
	HX_STACK_PUSH("TextField::get_embedFonts","native/text/TextField.hx",103);
	HX_STACK_THIS(this);
	HX_STACK_LINE(103)
	return true;
}
...
bool TextField_obj::set_displayAsPassword( bool inVal){
	HX_STACK_PUSH("TextField::set_displayAsPassword","native/text/TextField.hx",102);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(102)
...
bool TextField_obj::get_displayAsPassword( ){
	HX_STACK_PUSH("TextField::get_displayAsPassword","native/text/TextField.hx",101);
	HX_STACK_THIS(this);
	HX_STACK_LINE(101)
...
::native::text::TextFormat TextField_obj::set_defaultTextFormat( ::native::text::TextFormat inFormat){
	HX_STACK_PUSH("TextField::set_defaultTextFormat","native/text/TextField.hx",100);
	HX_STACK_THIS(this);
...
::native::text::TextFormat TextField_obj::get_defaultTextFormat( ){
	HX_STACK_PUSH("TextField::get_defaultTextFormat","native/text/TextField.hx",99);
	HX_STACK_THIS(this);
	HX_STACK_LINE(99)
...
int TextField_obj::get_bottomScrollV( ){
	HX_STACK_PUSH("TextField::get_bottomScrollV","native/text/TextField.hx",98);
	HX_STACK_THIS(this);
	HX_STACK_LINE(98)
...
int TextField_obj::set_borderColor( int inVal){
	HX_STACK_PUSH("TextField::set_borderColor","native/text/TextField.hx",97);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(97)
...
int TextField_obj::get_borderColor( ){
	HX_STACK_PUSH("TextField::get_borderColor","native/text/TextField.hx",96);
	HX_STACK_THIS(this);
	HX_STACK_LINE(96)
...
bool TextField_obj::set_border( bool inVal){
	HX_STACK_PUSH("TextField::set_border","native/text/TextField.hx",95);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(95)
...
bool TextField_obj::get_border( ){
	HX_STACK_PUSH("TextField::get_border","native/text/TextField.hx",94);
	HX_STACK_THIS(this);
	HX_STACK_LINE(94)
...
int TextField_obj::set_backgroundColor( int inVal){
	HX_STACK_PUSH("TextField::set_backgroundColor","native/text/TextField.hx",93);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(93)
...
int TextField_obj::get_backgroundColor( ){
	HX_STACK_PUSH("TextField::get_backgroundColor","native/text/TextField.hx",92);
	HX_STACK_THIS(this);
	HX_STACK_LINE(92)
...
bool TextField_obj::set_background( bool inVal){
	HX_STACK_PUSH("TextField::set_background","native/text/TextField.hx",91);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(91)
...
bool TextField_obj::get_background( ){
	HX_STACK_PUSH("TextField::get_background","native/text/TextField.hx",90);
	HX_STACK_THIS(this);
	HX_STACK_LINE(90)
...
::native::text::TextFieldAutoSize TextField_obj::set_autoSize( ::native::text::TextFieldAutoSize inVal){
	HX_STACK_PUSH("TextField::set_autoSize","native/text/TextField.hx",89);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(89)
...
::native::text::TextFieldAutoSize TextField_obj::get_autoSize( ){
	HX_STACK_PUSH("TextField::get_autoSize","native/text/TextField.hx",88);
	HX_STACK_THIS(this);
	HX_STACK_LINE(88)
...
int endIndex = __o_endIndex.Default(-1);
	HX_STACK_PUSH("TextField::setTextFormat","native/text/TextField.hx",74);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("TextField::setSelection","native/text/TextField.hx",67);
		HX_STACK_THIS(this);
		HX_STACK_ARG(beginIndex,"beginIndex");
		HX_STACK_ARG(endIndex,"endIndex");
	}
...
::String TextField_obj::getLineText( int lineIndex){
	HX_STACK_PUSH("TextField::getLineText","native/text/TextField.hx",60);
	HX_STACK_THIS(this);
...
int TextField_obj::getLineOffset( int lineIndex){
	HX_STACK_PUSH("TextField::getLineOffset","native/text/TextField.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lineIndex,"lineIndex");
	HX_STACK_LINE(53)
