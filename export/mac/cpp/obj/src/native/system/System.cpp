...
{
		HX_STACK_PUSH("System::exit","native/system/System.hx",15);
...
Void System_obj::gc( ){
{
		HX_STACK_PUSH("System::gc","native/system/System.hx",22);
		HX_STACK_LINE(22)
...
::String System_obj::get_deviceID( ){
	HX_STACK_PUSH("System::get_deviceID","native/system/System.hx",44);
	HX_STACK_LINE(44)
...
int System_obj::get_totalMemory( ){
	HX_STACK_PUSH("System::get_totalMemory","native/system/System.hx",47);
	HX_STACK_LINE(47)
