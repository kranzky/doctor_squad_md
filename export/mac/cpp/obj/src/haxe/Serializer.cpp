...
{
HX_STACK_PUSH("Serializer::new","/usr/lib/haxe/std/haxe/Serializer.hx",51);
{
	HX_STACK_LINE(52)
...
{
		HX_STACK_PUSH("Serializer::serializeException","/usr/lib/haxe/std/haxe/Serializer.hx",417);
		HX_STACK_THIS(this);
		HX_STACK_ARG(e,"e");
		HX_STACK_LINE(418)
		{
...
{
		HX_STACK_PUSH("Serializer::serialize","/usr/lib/haxe/std/haxe/Serializer.hx",158);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(158)
		{
...
{
		HX_STACK_PUSH("Serializer::serializeFields","/usr/lib/haxe/std/haxe/Serializer.hx",150);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(151)
		{
...
bool Serializer_obj::serializeRef( Dynamic v){
	HX_STACK_PUSH("Serializer::serializeRef","/usr/lib/haxe/std/haxe/Serializer.hx",113);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(117)
	{
...
{
		HX_STACK_PUSH("Serializer::serializeString","/usr/lib/haxe/std/haxe/Serializer.hx",94);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(95)
...
::String Serializer_obj::toString( ){
	HX_STACK_PUSH("Serializer::toString","/usr/lib/haxe/std/haxe/Serializer.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_LINE(60)
...
::String Serializer_obj::run( Dynamic v){
	HX_STACK_PUSH("Serializer::run","/usr/lib/haxe/std/haxe/Serializer.hx",436);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(437)
