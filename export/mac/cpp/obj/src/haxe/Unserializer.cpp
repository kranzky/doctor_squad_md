...
{
HX_STACK_PUSH("Unserializer::new","/usr/lib/haxe/std/haxe/Unserializer.hx",64);
{
	HX_STACK_LINE(65)
	this->buf = buf;
	HX_STACK_LINE(66)
...
Dynamic Unserializer_obj::unserialize( ){
	HX_STACK_PUSH("Unserializer::unserialize","/usr/lib/haxe/std/haxe/Unserializer.hx",151);
	HX_STACK_THIS(this);
	HX_STACK_LINE(152)
		...
		case (int)111: {
			struct _Function_2_1{
				inline static Dynamic Block( ){
					HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/haxe/Unserializer.hx",208);
					{
...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	HX_STACK_PUSH("Unserializer::unserializeEnum","/usr/lib/haxe/std/haxe/Unserializer.hx",139);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Unserializer::unserializeObject","/usr/lib/haxe/std/haxe/Unserializer.hx",124);
		HX_STACK_THIS(this);
		HX_STACK_ARG(o,"o");
		HX_STACK_LINE(125)
		while((true)){
...
int Unserializer_obj::readDigits( ){
	HX_STACK_PUSH("Unserializer::readDigits","/usr/lib/haxe/std/haxe/Unserializer.hx",99);
	HX_STACK_THIS(this);
	HX_STACK_LINE(100)
...
int Unserializer_obj::get( int p){
	HX_STACK_PUSH("Unserializer::get","/usr/lib/haxe/std/haxe/Unserializer.hx",95);
	HX_STACK_THIS(this);
	HX_STACK_ARG(p,"p");
	HX_STACK_LINE(95)
...
Dynamic Unserializer_obj::getResolver( ){
	HX_STACK_PUSH("Unserializer::getResolver","/usr/lib/haxe/std/haxe/Unserializer.hx",91);
	HX_STACK_THIS(this);
	HX_STACK_LINE(91)
...
{
		HX_STACK_PUSH("Unserializer::setResolver","/usr/lib/haxe/std/haxe/Unserializer.hx",81);
		HX_STACK_THIS(this);
		HX_STACK_ARG(r,"r");
		HX_STACK_LINE(81)
		if (((r == null()))){
			struct _Function_2_1{
				inline static Dynamic Block( ){
					HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/haxe/Unserializer.hx",83);
					{
						hx::Anon __result = hx::Anon_obj::Create();

						HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_3_1)
						::Class run(::String _){
							HX_STACK_PUSH("*::_Function_3_1","/usr/lib/haxe/std/haxe/Unserializer.hx",84);
							HX_STACK_ARG(_,"_");
							{
								HX_STACK_LINE(84)
								return null();
						...
						::Enum run(::String _){
							HX_STACK_PUSH("*::_Function_3_2","/usr/lib/haxe/std/haxe/Unserializer.hx",85);
							HX_STACK_ARG(_,"_");
							{
								HX_STACK_LINE(85)
								return null();
...
Array< int > Unserializer_obj::initCodes( ){
	HX_STACK_PUSH("Unserializer::initCodes","/usr/lib/haxe/std/haxe/Unserializer.hx",41);
	HX_STACK_LINE(42)
...
Dynamic Unserializer_obj::run( ::String v){
	HX_STACK_PUSH("Unserializer::run","/usr/lib/haxe/std/haxe/Unserializer.hx",351);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(351)
