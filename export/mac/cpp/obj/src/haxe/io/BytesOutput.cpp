...
{
HX_STACK_PUSH("BytesOutput::new","/usr/lib/haxe/std/haxe/io/BytesOutput.hx",35);
{
	HX_STACK_LINE(35)
...
::haxe::io::Bytes BytesOutput_obj::getBytes( ){
	HX_STACK_PUSH("BytesOutput::getBytes","/usr/lib/haxe/std/haxe/io/BytesOutput.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(126)
...
int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_PUSH("BytesOutput::writeBytes","/usr/lib/haxe/std/haxe/io/BytesOutput.hx",52);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("BytesOutput::writeByte","/usr/lib/haxe/std/haxe/io/BytesOutput.hx",44);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(44)
		this->b->b->push(c);
