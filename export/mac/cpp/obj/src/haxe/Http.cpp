...
{
HX_STACK_PUSH("Http::new","/usr/lib/haxe/std/haxe/Http.hx",69);
{
	HX_STACK_LINE(70)
	this->url = url;
	HX_STACK_LINE(71)
...
Void run(int status){
{
		HX_STACK_PUSH("Http::onStatus","/usr/lib/haxe/std/haxe/Http.hx",629);
		HX_STACK_THIS(this);
...
Void run(::String msg){
{
		HX_STACK_PUSH("Http::onError","/usr/lib/haxe/std/haxe/Http.hx",626);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Http::onData","/usr/lib/haxe/std/haxe/Http.hx",623);
		HX_STACK_THIS(this);
...
bool Http_obj::readChunk( ::EReg chunk_re,::haxe::io::Output api,::haxe::io::Bytes buf,int len){
	HX_STACK_PUSH("Http::readChunk","/usr/lib/haxe/std/haxe/Http.hx",564);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Http::readHttpResponse","/usr/lib/haxe/std/haxe/Http.hx",425);
		HX_STACK_THIS(this);
		HX_STACK_ARG(api,"api");
...
{
		HX_STACK_PUSH("Http::customRequest","/usr/lib/haxe/std/haxe/Http.hx",269);
		HX_STACK_THIS(this);
		...
		struct _Function_1_1{
			inline static int Block( bool &secure){
				HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/haxe/Http.hx",293);
				{
					HX_STACK_LINE(293)
...
{
		HX_STACK_PUSH("Http::fileTransfert","/usr/lib/haxe/std/haxe/Http.hx",265);
		HX_STACK_THIS(this);
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::haxe::io::Input &file,int &size,::String &argname,::String &filename){
				HX_STACK_PUSH("*::closure","/usr/lib/haxe/std/haxe/Http.hx",266);
				{
...
{
		HX_STACK_PUSH("Http::request","/usr/lib/haxe/std/haxe/Http.hx",98);
		HX_STACK_THIS(this);
		HX_STACK_ARG(post,"post");
		HX_STACK_LINE(99)
		...
		Void run(::String e){
			HX_STACK_PUSH("*::_Function_1_1","/usr/lib/haxe/std/haxe/Http.hx",249);
			HX_STACK_ARG(e,"e");
			{
				HX_STACK_LINE(250)
				err[(int)0] = true;
...
{
		HX_STACK_PUSH("Http::setPostData","/usr/lib/haxe/std/haxe/Http.hx",91);
		HX_STACK_THIS(this);
		HX_STACK_ARG(data,"data");
		HX_STACK_LINE(91)
		this->postData = data;
...
{
		HX_STACK_PUSH("Http::setParameter","/usr/lib/haxe/std/haxe/Http.hx",87);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Http::setHeader","/usr/lib/haxe/std/haxe/Http.hx",83);
		HX_STACK_THIS(this);
...
::String Http_obj::requestUrl( ::String url){
	HX_STACK_PUSH("Http::requestUrl","/usr/lib/haxe/std/haxe/Http.hx",633);
	...
	Void run(::String d){
		HX_STACK_PUSH("*::_Function_1_1","/usr/lib/haxe/std/haxe/Http.hx",639);
		HX_STACK_ARG(d,"d");
		{
			HX_STACK_LINE(639)
			r[(int)0] = d;
	...
	Void run(::String e){
		HX_STACK_PUSH("*::_Function_1_2","/usr/lib/haxe/std/haxe/Http.hx",642);
		HX_STACK_ARG(e,"e");
		{
			HX_STACK_LINE(642)
			hx::Throw (e);
