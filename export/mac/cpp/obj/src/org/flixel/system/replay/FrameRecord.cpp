	...
	if (((keyData.length > (int)0))){
		...
		while(((i < l))){
			...
			if (((keyPair->length == (int)2))){
				...
				if (((this->keys == null()))){
					HX_STACK_LINE(123)
					this->keys = Array_obj< ::org::flixel::system::replay::CodeValuePair >::__new();
				}
				HX_STACK_LINE(126)
...
::org::flixel::system::replay::FrameRecord FrameRecord_obj::create( Float Frame,Array< ::org::flixel::system::replay::CodeValuePair > Keys,::org::flixel::system::replay::MouseRecord Mouse){
...
Dynamic FrameRecord_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"keys") ) { keys=inValue.Cast< Array< ::org::flixel::system::replay::CodeValuePair > >(); return inValue; }
		break;
	case 5:
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.replay.FrameRecord"), hx::TCanCast< FrameRecord_obj> ,sStaticFields,sMemberFields,
