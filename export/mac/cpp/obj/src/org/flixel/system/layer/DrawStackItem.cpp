...
{
		HX_STACK_PUSH("DrawStackItem::dispose","org/flixel/system/layer/DrawStackItem.hx",27);
		HX_STACK_THIS(this);
		HX_STACK_LINE(28)
		this->atlas = null();
		HX_STACK_LINE(29)
...
{
		HX_STACK_PUSH("DrawStackItem::reset","org/flixel/system/layer/DrawStackItem.hx",20);
		HX_STACK_THIS(this);
		HX_STACK_LINE(21)
		this->atlas = null();
		HX_STACK_LINE(22)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.system.layer.DrawStackItem"), hx::TCanCast< DrawStackItem_obj> ,sStaticFields,sMemberFields,
